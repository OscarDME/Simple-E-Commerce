  ...
  return (
    <div className = "p-5">
      <div>
        ...
        <div className="py-4">
          <div className="w-64">
            <div className = "bg-blue-100 p-5 runded-xl">
              <img src="/products/iphone.png" alt="phone" />
            </div>
            <div className = "mt-2">
              <h3 className = "font-bold text-lg">Iphone 14 Pro</h3>
            </div>
            <p className = "text-sm mt-1 leading-4">lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, quod.</p>
